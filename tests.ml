...
(* TEST 1: MAP { ?x, type, Car ?x, hasColor, Red } *)
let test1 _ =
	let db = Moana_lists.S.init tuples in
	let query1 = [ q1; q2 ] and q1_exp_res = [ [ t1; t9 ] ] in
	let res_q1 = Moana_lists.S.query db query1
	in assert_equal q1_exp_res res_q1

(* print_tuples_list res_q1;; print_tuples_list q1_exp_res;; TEST 2: MAP { *)
...
(* TEST 3: similar to test 1 query but the order of the tuple template is  *)
...
(* print_tuples_list res_q2;; print_tuples_list q2_exp_res;; TEST 4: -     *)
(* Note - expected results are order sensetive MAP { ?x, relatesTo, ?y ?y, *)
(* relatesTo, ?x }                                                         *)
let test4 _ =
...
(* TEST 2: MAP { ?x, type, Car ?x, hasColor, ?y ?y, type, Color ?y,        *)
(* rgbValue, White }                                                       *)
let test9 _ =
	let q9_exp_res =
...
(* TEST 10: MAP { ?x, type, Car ?x, hasColor, Red } *)
let test10 _ =
...
(* Test 11 Tests the add function and to_list function *)
